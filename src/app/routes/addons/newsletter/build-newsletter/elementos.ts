  ...
  },
  {
    ...
    <tbody style="outline: none !important;">  
     <tr style="background-color:white;border:none; outline: none !important;text-align: center;">
          <td style="width:45%;background-color:white;border:none;margin: 0;padding: 0;"></td>
          <td style="width:45%;background-color:white;border:none;margin: 0;padding: 0;"></td>
      </tr>
    </tbody>
    </table>`,
  ...
  },
  {
    ...
    <table cellspacing="5" style="margin: auto; padding:10px; width: 50%; text-align:center;">
      <tr style="height:60px">
        <td style="width:20%;">
          <a href="" ><img src="https://ayuntamientoadeje.curieplatform.com/crm/storage/RRSS/Instagram_color.png" height="35px"/></a>
        </td>
        <td style="width:20%;">
          <a href="" > <img src="https://ayuntamientoadeje.curieplatform.com/crm/storage/RRSS/Facebook_color.png" height="35px"> </a>
        </td>
        <td style="width:20%;">
          <a href="" > <img src="https://ayuntamientoadeje.curieplatform.com/crm/storage/RRSS/Twitter_color.png" height="35px"> </a>
        </td>
        <td style="width:20%;">
        <a href="" > <img src="https://ayuntamientoadeje.curieplatform.com/crm/storage/RRSS/Pinterest_color.png" height="35px"> </a>
        </td>
        <td style="width:20%;">
        <a href="" > <img src="https://ayuntamientoadeje.curieplatform.com/crm/storage/RRSS/Youtube_color.png" height="35px"> </a>
        </td>
      </tr>
    </table>
    `,    
